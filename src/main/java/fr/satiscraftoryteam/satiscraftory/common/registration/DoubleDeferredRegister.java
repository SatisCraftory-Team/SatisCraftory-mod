...
public class DoubleDeferredRegister<PRIMARY, SECONDARY> {
    ...
    protected DoubleDeferredRegister(String modid, ResourceKey<? extends Registry<PRIMARY>> primaryRegistryName,
        ...
        this(modid, primaryRegistryName, WrappedDeferredRegister.create(secondaryRegistryName, modid));
    }
    ...
    protected DoubleDeferredRegister(String modid, ResourceKey<? extends Registry<PRIMARY>> primaryRegistryName, DeferredRegister<SECONDARY> secondaryRegistry) {
        this(WrappedDeferredRegister.create(primaryRegistryName, modid), secondaryRegistry);
    }

    public <P extends PRIMARY, S extends SECONDARY, W extends DoubleWrappedDeferredHolder<PRIMARY, P, SECONDARY, S>> W register(String name,
    ...
    public <P extends PRIMARY, S extends SECONDARY, W extends DoubleWrappedDeferredHolder<PRIMARY, P, SECONDARY, S>> W registerAdvanced(String name,
