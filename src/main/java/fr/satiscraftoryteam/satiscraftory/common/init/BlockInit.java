...
//    public static final DeferredRegister.Blocks BLOCKSs = DeferredRegister.createBlocks(SatisCraftory.MODID);
    ...
    public static final BlockRegistryObject<Block, BlockItem> IRON_RESOURCE_NODE = BLOCKS.register("iron_resource_node", () -> new DepositBlock(ItemInit.IRON_RESIDUE));
    public static final BlockRegistryObject<Block, BlockItem> COPPER_DEPOSIT =  BLOCKS.register("copper_deposit", () -> new DepositBlock(ItemInit.COPPER_RESIDUE));
...
//    public static final BlockRegistryObject<Block, BlockItem> IRON_RESOURCE_DEPOSIT = BLOCKS.register("iron_resource_deposit", () -> new DepositBlock(ItemInit.IRON_RESIDUE));
//    public static final BlockRegistryObject<Block, BlockItem> IRON_RESOURCE_NODE = BLOCKS.register("iron_resource_node", () -> new Block(BlockBehaviour.Properties.of().noOcclusion()));
    ...
    public static final BlockRegistryObject<MinerMk1Block, BlockItem> MINER_MK1 =     BLOCKS.register("miner_mk1", MinerMk1Block::new, (block) -> new MinerMk1Item(block, new Item.Properties()));

    public static final BlockRegistryObject<SmelterBlock, BlockItem> SMELTER =        BLOCKS.register("smelter", SmelterBlock::new, (block) -> new SmelterItem(block, new Item.Properties()));
