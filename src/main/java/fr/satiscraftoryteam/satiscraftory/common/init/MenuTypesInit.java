...
public class MenuTypesInit {
  ...
  //  public static final Supplier<MenuType<MinerMk1Menu>> MINER_MK1_MENU = registerMenuType(MinerMk1Menu::new, "miner_mk1_menu");
   ...
   // public static final Supplier<MenuType<SmelterMenu>> SMELTER_MENU = registerMenuType(SmelterMenu::new, "smelter_menu");

  //  public static final Supplier<MenuType<BuilderToolMenu>> BUILDER_TOOL_MENU = registerMenuType(BuilderToolMenu::new, "builder_tool");
