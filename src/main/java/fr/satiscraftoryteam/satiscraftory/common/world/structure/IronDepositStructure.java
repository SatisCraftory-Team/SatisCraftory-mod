package fr.satiscraftoryteam.satiscraftory.common.world.structure;
...
public class IronDepositStructure extends Structure {
    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<IronDepositStructure> CODEC = RecordCodecBuilder.<IronDepositStructure>mapCodec(instance ->
            instance.group(IronDepositStructure.settingsCodec(instance),
            ...
            ).apply(instance, IronDepositStructure::new)).codec();
    ...
    public IronDepositStructure(Structure.StructureSettings config,
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        if (!IronDepositStructure.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return StructuresInit.IRON_DEPOSIT_STRUCTURES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}
