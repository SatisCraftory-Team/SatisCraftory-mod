...
public class ModPackets extends AbtractPacketHandler {
    ...
    protected void registerClientToServer(PacketRegistrar registrar) {
        ...
        registrar.play(UpdateMachineInfosServer.TYPE, UpdateMachineInfosServer.STREAM_CODEC);
    }

    @Override
    protected void registerServerToClient(PacketRegistrar registrar) {
        registrar.play(UpdateMachineInfosClient.TYPE, UpdateMachineInfosClient.STREAM_CODEC);
