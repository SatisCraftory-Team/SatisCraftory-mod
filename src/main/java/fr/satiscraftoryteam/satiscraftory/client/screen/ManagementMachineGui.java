...
public class ManagementMachineGui extends AbstractContainerScreen {
    ...
    public ManagementMachineGui(AbstractContainerMenu menu, Inventory inventory, Component component) {
    ...
    protected void renderBg(PoseStack poseStack, float PartialTick, int pMouseX, int pMouseY) {
        ...
        this.blit(poseStack, x+imageWidth, y+10, 106, 60, 176, 120);
