...
import fr.vgtom4.satiscraftory.block.custom.Eliocube;
import fr.vgtom4.satiscraftory.block.custom.MinerMk1Block;
...
public class BlockInit {
    ...
    public static final RegistryObject<Block> ELIOCUBE = registerBlockWithoutBlockItem("eliocube", () -> new Eliocube(BlockBehaviour.Properties.of(Material.METAL).noOcclusion()));
